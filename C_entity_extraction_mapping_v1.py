...
# =========================================================
# C ENTITY EXTRACTION MAPPING - STAGE 2 PREPARATION
# =========================================================
# מטרת הקוד:
# להוציא מתוך עמותות C ישויות רפואיות נקיות:
...
OUTPUT_FILE = BASE_DIR / "C_entity_extraction_mapping_v1.xlsx"
...
df_B = df_final[
    df_final["auto_category"].astype(str).str.strip() == "C"
].copy()

print("C rows:", len(df_B))

# =========================================================
# DISEASE ALIASES
# =========================================================
# אלה מונחים שאם מופיעים במשימה,
# כנראה מדובר ב-A שהוחמצה או ב-move_to_A_candidate.
# =========================================================
